    ...
    <SectionWrapper id="cta-footer" bgColor="bg-[#FAF9F5]" glowPosition="top-left">
      <Container>
        <div className="w-full max-w-5xl mx-auto">
          <div className="bg-forest text-cream rounded-[40px] px-6 py-16 sm:p-20 text-center flex flex-col items-center shadow-premium relative overflow-hidden border border-white/5">
            ...
            <BackgroundPattern variant="doodle" opacity={0.12} className="text-cream" />
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight font-heading leading-tight mb-6 text-cream max-w-2xl relative z-10">
              {title}
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-cream/80 leading-relaxed font-body mb-10 max-w-xl relative z-10">
              {description}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full sm:w-auto relative z-10">
              ...
              <Link
                ...
                className="w-full sm:w-56 inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-white/10 hover:bg-white text-cream hover:text-forest border border-cream/30 rounded-full font-heading font-bold text-sm shadow-xs hover:shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-cream/40"
              >
                <Users size={16} />
