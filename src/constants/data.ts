...
export const missionData = {
  ...
  bullets: [
    "Arts & Creativity: Building local learning hubs that provide accessible resources and foster collaborative growth.",
    "STEM & Innovation: Advocating for equitable access to educational tools and empowering marginalized voices.",
    "Environment & Nature: Collaborating with like-minded organizations to amplify our impact and reach.",
    "Holistic Well-being: An inspiring well-being process and holistic healthcare health."
  ],
...
export const focusCardsData = [
  {
    ...
    description: "Building local learning hubs that provide accessible resources and foster collaborative growth.",
    icon: "palette",
    pattern: "leaf" as const,
  },
  {
    title: "STEM & Innovation",
    description: "Advocating for equitable access to educational tools and empowering marginalized voices.",
    icon: "gear",
